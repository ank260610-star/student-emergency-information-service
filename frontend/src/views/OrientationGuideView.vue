    ...
    <section class="orientation-timeline" aria-labelledby="timeline-title">
      ...
      <article id="step-card" class="timeline-step" :class="{ open: isOpen('card') }">
        ...
        <div class="timeline-card">
          ...
          <div v-show="isOpen('card')" id="detail-card" class="timeline-detail"><ol class="action-list"><li><strong>连接校园网：</strong>选择无线网络 <code>NKU_WLAN</code>，打开任意网页进入认证页；用户名为学号，初始密码为证件号后 6 位（字母大写）。</li><li><strong>领取校园卡：</strong>普通新生卡由学校统一预制，通常在报到点免费领取。现场先核对姓名与学号。</li><li><strong>绑定微信：</strong>微信搜索并关注“南开大学一卡通”，选择“校园卡 → 校园卡绑定”，通过统一身份认证。</li><li><strong>充值：</strong>公众号选择“卡片充值”。充值先进入过渡余额，第一次到食堂消费时需在 POS 机上刷实体卡，将金额写入卡内。</li></ol><div class="service-points"><div><small>津南日常服务</small><strong>综合业务西楼师生服务大厅 16—17 窗口</strong></div><div><small>津南补卡与密码重置</small><strong>师生服务大厅 19 号窗口 · 022-85358890 转19</strong></div><div><small>八里台线下服务</small><strong>服务楼 103（网络）/ 104（校园卡）</strong></div></div><div class="link-row"><a href="https://wxb.nankai.edu.cn/info/1141/1710.htm" target="_blank" rel="noopener">公众号绑定、充值与联网官方说明 →</a><a href="https://netservice.nankai.edu.cn/" target="_blank" rel="noopener">校园网自助服务 →</a></div></div>
        </div>
      </article>
